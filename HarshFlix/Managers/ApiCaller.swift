...
struct Constants{
    ...
    static let YOUTUBE_API_KEY = "" // key from youtubeapi
    ...
    static let keyReloadTablDiscover = ""
...
class ApiCaller{
    ...
    func getYoutube(with query : String, completion : @escaping(Result<YoutubeVideo,Error>) -> Void){
